...
export default class Chat extends Component {
    ...
    componentDidMount() {
        this.socket.on('message', (conversation) => { // got message
            this.setState({conversation: conversation, messageAlert: "Nuevo mensaje", notification: true});
        });
    ...
    closeBox = () => {
        this.setState({box: false, btn: true, messageAlert: "Click para el chat"});
    };
    sendMessage = (event) => {
